...
public class TaskDaoMySqlImpl implements TaskDao{
    ...
    public int insert(Task task){
        ...
        MapSqlParameterSource parameters = new MapSqlParameterSource()
                ...
                .addValue("assignorId",     task.getAssignorId())
        ...
        namedParameterJdbcTemplate.update("Insert into tasks (name, description, taskStatus,  assignorId, assigneeId, startDate, createdDate, dueDate)"
                        + "VALUES(:name, :description, :taskStatus, :assignorId, :assigneeId, :startDate, :createdDate, :dueDate)",
    ...
    public List<Task> query(QueryRequest queryRequest){
        ...
        if (!Util.isInValidInt(queryRequest.assigneeId)) {
            sql.append(" and assigneeId = :assigneeId");
            parameters.addValue("assigneeId", queryRequest.assigneeId);
        }
