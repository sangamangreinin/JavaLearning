...
public class BankMenu {
    ...
    static HashMap<Long, Account> accountsList = bankService.deserializeAccounts();
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            bankService.optionSelection(scanner, selection, accountsList);
        }
        while (autoRun);
    }
}
    ...
    public void optionSelection(Scanner scanner, int selection, HashMap<Long, Account> accountsList) {
        switch (selection) {
            case 1:
                ...
                Customer customer = null;
                do {
                    customer = helper.getCustomerInfo(scanner);
                } while (customer == null);
