...
public class SystemConstants {
    public static final float SAVING_INTEREST_RATE = 10.0f;
    public static final float MINIUM_BALANCE_ACCOUNT_OPEN = 2000;
    public static final float REQUIRE_PAN_AMOUNT = 50000;
